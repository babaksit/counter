...
* runs it through a list of validators that are responsible for checking the input for specific conditions.
*/
class CounterInputValidator {
private:
/**
...
*/
std::vector<std::unique_ptr<StringCharValidator>> validators;
public:
/**
* @brief add a validator
* This function adds a unique pointer of StringCharValidator to the vector of validators
...
* This function takes in a string and character and runs it through all the validators in the vector
* @param str The const reference of string to be validated
* @param ch The const reference of character to be validated
*/
